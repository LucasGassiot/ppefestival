...
class='tabQuadrille'>";
   ...
   while ($lgEtab!=FALSE)
   {
      ...
      echo "
      <td valign='top' width='$pourcCol%'><i>Disponibilit&eacutes : $nbChLib </i> <br>
      $nom </td>";
      $lgEtab=mysql_fetch_array($rsEtab);
   }
   echo "
   ...
   foreach ($lgGroupe as $ligne)
   {
      ...
      while ($lgEtab!=FALSE)
      {
         ...
         $nbOccupGroupe=obtenirNbOccupGroupe($connexion, $idEtab, $idGroupe, $LaDate);
...
<table align='center' width='80%'>
   <tr>
      ...
      <td width='30%' align='left'>R&eacuteservation possible si lien</td>
      <td class='reserve'>&nbsp;</td>
      <td width='30%' align='left'>Chambres r&eacuteserv&eacutees</td>
   </tr>
</table>";
